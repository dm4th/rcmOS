...
async function handler(req: Request) {
    ...
    try {
        ...
        const outputSchema = z.object({
            relevant: z.boolean().describe('Only true if the section of the form is relevant to the MEDICAL reason for the claim denial. Defer to false if not 100% certain of the medical reasoning. The reason must be medical and not administrative.'),
            ...
            elements: z.array(z.object({
                id: z.string().describe('The ID of the data element you have found a value for in the processed set of key-value pairs.'),
            ...
            })).optional().describe('An array of data elements found in the section of the processed key-value pairs that match a field in the common data elements table. If no data elements are found, this field will not be present.'),
        });
