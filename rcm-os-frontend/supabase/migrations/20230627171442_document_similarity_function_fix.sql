CREATE OR REPLACE FUNCTION "public"."document_similarity"("embedding" vector(1536), "record_id" text, "match_threshold" double precision, "match_count" integer)
RETURNS TABLE (
    "type" text,
    "page" integer,
    "title" text,
...
ALTER FUNCTION "public"."document_similarity"("embedding" vector(1536), "record_id" text, "match_threshold" double precision, "match_count" integer) OWNER TO "postgres";